<?php  //[STAMP] aac366345a4deb54c9d70ce824b82a5a
...
use Helper\Acceptance_base;
use Codeception\Module\MultiDb;

trait Acceptance_baseTesterActions
{
    /**
     ...
     * @see \Codeception\Module\MultiDb::amConnectedToDatabase()
     */
     ...
     *
     * @return integer $id
     * @see \Codeception\Module\MultiDb::haveInDatabase()
     */
     ...
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Codeception\Module\MultiDb::seeInDatabase()
     */
     ...
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Codeception\Module\MultiDb::seeNumRecords()
     */
     ...
     * Conditional Assertion: Test won't be stopped on fail
     * @see \Codeception\Module\MultiDb::dontSeeInDatabase()
     */
     ...
     *
     * @return mixed
     * @see \Codeception\Module\MultiDb::grabFromDatabase()
     */
     ...
     *
     * @return int
     * @see \Codeception\Module\MultiDb::grabNumRecords()
     */
     ...
     * @see \Codeception\Module\MultiDb::checkDatabaseInConfig()
     */
    public function checkDatabaseInConfig($connection) {
        return $this->getScenario()->runStep(new \Codeception\Step\Action('checkDatabaseInConfig', func_get_args()));
    }
     ...
     *
     * @return \PDOStatement
     * @see \Codeception\Module\MultiDb::amRunPlainSql()
     */
    public function amRunPlainSql($query, $params = null) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amRunPlainSql', func_get_args()));
    }
     ...
     * @see \Codeception\Module\MultiDb::amTruncateTable()
     */
    public function amTruncateTable($table) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amTruncateTable', func_get_args()));
    }
     ...
     *
     * @param string $connection
     * @see \Codeception\Module\MultiDb::amLoadDump()
     */
    public function amLoadDump($connection) {
        return $this->getScenario()->runStep(new \Codeception\Step\Condition('amLoadDump', func_get_args()));
    }
}
